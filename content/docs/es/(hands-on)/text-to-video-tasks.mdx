...
- Proveedor mock de desarrollo: define `ENABLE_DEMO_FEATURES=true`, `ENABLE_TEXT2VIDEO_MOCK=true` y, opcionalmente, `TEXT2VIDEO_MOCK_URL` en `.env.local`.
