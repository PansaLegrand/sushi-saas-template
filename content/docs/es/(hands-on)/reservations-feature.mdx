...
canonical: "https://www.sushi-templates.com/es/blogs/reservations-feature"
---
...
Ajusta horarios, retención y zona horaria en `src/config/reservations.ts`.
...
- Zona horaria base: edita `baseTimeZone` en `src/config/reservations.ts` (p.ej., `Europe/Madrid`).
