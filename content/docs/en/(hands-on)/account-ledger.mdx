...
canonical: "https://www.sushi-templates.com/docs/account-ledger"
---
...
- `src/services/stripe/checkout-session.ts#handleCheckoutSession` — turns a paid session into an order status + grant row.
...
2. **Create a user**: visit `/signup`, register, and sign in.
