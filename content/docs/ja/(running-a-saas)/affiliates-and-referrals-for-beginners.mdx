...
canonical: "https://www.sushi-templates.com/ja/blogs/affiliate-and-reward"
---
...
- 管理ページ: 全体一覧と集計
  - `apps/admin/app/(admin)/affiliates/page.tsx:1`
...
- 管理者: `/affiliates` で全行/合計/CSV エクスポート。
