...
canonical: "https://www.sushi-templates.com/fr/blogs/affiliate-and-reward"
---
...
- Page admin : `apps/admin/app/(admin)/affiliates/page.tsx`
...
4) Vues → `/[locale]/my-invites` (utilisateur), `/affiliates` (admin).
