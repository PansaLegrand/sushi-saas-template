...
- Fournisseur mock de développement : définissez `ENABLE_DEMO_FEATURES=true`, `ENABLE_TEXT2VIDEO_MOCK=true` et, optionnellement, `TEXT2VIDEO_MOCK_URL` dans `.env.local`.
