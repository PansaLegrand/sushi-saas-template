...
- Locales incluses dans `src/i18n/locale.ts` ; les locales actives se règlent avec `NEXT_PUBLIC_LOCALES`
- Anglais seul : `NEXT_PUBLIC_LOCALES=en` ; anglais et espagnol : `NEXT_PUBLIC_LOCALES=en,es`
...
2) Ajouter le code dans `availableLocales` (`src/i18n/locale.ts`)
3) Inclure le code dans `NEXT_PUBLIC_LOCALES`
...
- Si une route de langue renvoie 404, ajouter le code à `NEXT_PUBLIC_LOCALES` et redémarrer
