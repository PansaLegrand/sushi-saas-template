...
canonical: "https://www.sushi-templates.com/es/blogs/affiliate-and-reward"
---
...
- Página de admin: `apps/admin/app/(admin)/affiliates/page.tsx`
...
4) Vistas → `/[locale]/my-invites` para el usuario; `/affiliates` para administradores.
