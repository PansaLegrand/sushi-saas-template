...
Esta guía explica cómo funciona la autenticación web de extremo a extremo: registro, login y mantenerse autenticado. Compara JWT con sesiones, “remember me” vs refresh, y muestra cómo OAuth (Google) encaja en el mismo flujo.
...
- La autenticación siempre cubre: registro, login y sesión persistente.
- JWT y sesiones resuelven lo mismo con mecánicas distintas.
- Access token / session ID son cortos; refresh / remember los renuevan.
- OAuth solo reemplaza la verificación de contraseña; tú emites tu sesión/JWT.
- Elige JWT para clientes distribuidos; sesiones para revocación simple y apps clásicas.
